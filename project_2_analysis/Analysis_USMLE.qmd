...
## Q2 what we want to report after all
```{r}
mod2_cont <-  lm(score_step2 ~ uworld_clean + amboss_clean + as.numeric(length_step2) + simulate_full_practice + practice_score_step2 + number_of_practice_tests + school_factor, data = step2_impute) 

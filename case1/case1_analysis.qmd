...
### PCA
We did further analysis with K means clustering with 4 groups in an effort to identify particular groups of students classified based on their scores as an additional way to justify a separation threshold for failing.
```{r}
#| warning: false
#k means clusters
